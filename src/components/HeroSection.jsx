...
export default function HeroSection() {
  ...
  return (
    <div className="container relative text-text">
      <div className="relative h-60 lg:h-80 xl:h-100 rounded-lg overflow-hidden">
        ...
        current === idx
          ...
          >
            ...
            <div className="absolute inset-0 bg-black/50 flex items-center gap-2 p-2">
              {/* Poster */}
              <div className="p-2 w-28 lg:w-40 xl:w-70 shrink-0">
                <img
              ...
              <div className="flex flex-col gap-2 max-w-lg pb-5">
                <div className="flex gap-1 items-center text-sm">
                  <p className="text-[7px] lg:text-[15px] bg-yellow-600 w-7 lg:w-15 h-3 lg:h-7 lg:font-bold text-center rounded-sm text-black">
                    Tmdb
                  </p>
                  <p className="text-[10px] lg:text-[20px]">{slide.rating}</p>
                </div>
                <p className="text-sm font-bold lg:text-2xl xl:text-5xl">{slide.title}</p>
                <p className="text-[10px] font-extralight lg:text-lg lg:font-normal">
                  {slide.desc}
                </p>
                <div className="flex pt-2 gap-1">
                  <button className="bg-secondary rounded-sm p-1 text-[10px] border border-transparent hover:border-secondary hover:bg-black/50 hover:text-secondary transition-all lg:text-[15px]">
                    See Detail
                  </button>
                  <button className="rounded-sm font-bold bg-linear-60/oklch from-secondary via-accent bg-clip-text text-transparent to-highlight p-1 text-[10px] border border-transparent hover:bg-clip-border hover:bg-black/30 hover:text-white transition-all lg:text-[15px]">
                    Add Watchlist
                  </button>
                </div>
              </div>
